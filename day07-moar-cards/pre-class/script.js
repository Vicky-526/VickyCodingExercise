// define a deck of cards with objects with arrays
var deck = [
  {
    name: "ace",
    suit: "hearts",
...
// apply shuffle function on the defined card deck
...
var highestCardsMain = function (input) {
  var computerFirst = shuffledDeck.pop();
  var computerSecond = shuffledDeck.pop();
  var playerFirst = shuffledDeck.pop();
  var playerSecond = shuffledDeck.pop();
  var myOutputValue =
    "Computer draw: " +
    computerFirst.name +
    " of " +
    ...
    ".<br>";
  if (
    computerFirst.rank > playerFirst.rank &&
    computerFirst.rank > playerSecond.rank
  ) {
    myOutputValue += "Computer wins!";
    return myOutputValue;
  }
  if (
    computerSecond.rank > playerFirst.rank &&
    computerSecond.rank > playerSecond.rank
  ) {
    myOutputValue += "Computer wins!";
    return myOutputValue;
  }
  if (
    playerFirst.rank > computerFirst.rank &&
    playerFirst.rank > computerSecond.rank
  ) {
    myOutputValue += "Player wins!";
    return myOutputValue;
  }
  if (
    playerSecond.rank > computerFirst.rank &&
    playerSecond.rank > computerSecond.rank
  ) {
    myOutputValue += "Player wins!";
    return myOutputValue;
  } else {
